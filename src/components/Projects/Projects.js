...
<svg width="${w}" height="${h}" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  <defs>
    <linearGradient id="g">
      <stop stop-color="#19273b" offset="20%" />
      <stop stop-color="#153d73" offset="50%" />
      <stop stop-color="#19273b" offset="70%" />
    </linearGradient>
  </defs>
  <rect width="${w}" height="${h}" fill="#19273b" />
...
function Projects(){
  ...
  return(
    <Section nopadding id="projects">
      ...
      <SectionTitle2 initial={{ x: -100, opacity: 0 }} animate={animateTitle(0.9, inView, entry)} $main>Projects</SectionTitle2>
      <div ref={ref}>
        <GridContainer
        >
          {
